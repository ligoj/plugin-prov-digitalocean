...
e.DBAAS_SIZES=[
	...
	{cpu:1,monthlyPrice:11,memory:2*l,doDisk:30,disk:25},
	{cpu:2,monthlyPrice:21,memory:4*l,disk:38,doDisk:80},
	{cpu:4,monthlyPrice:41,memory:8*l,disk:115,doDisk:175},
	{cpu:6,monthlyPrice:81,memory:16*l,disk:270,doDisk:350},
	{cpu:8,monthlyPrice:161,memory:32*l,disk:580,doDisk:700},
	{cpu:16,monthlyPrice:321,memory:64*l,doDisk:1e3,disk:1150,excludeLayouts:["single_node"]}]
